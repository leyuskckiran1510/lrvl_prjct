    ...
    <script>
        $(function() {
            ...
            $("#gFile").on("change", function(e) {
                ...
                $.each(photos, function(key, val) { // Fixed typo here
                    $("#galUpload").prepend(`<div class='item gitems'><img src='${URL.createObjectURL(val)}' /></div>`); // Corrected usage
                });
            });
            ...
            $("input[name='name']").on("change", function() {
                ...
                console.log("Slug generated:", slug); // Log the generated slug
